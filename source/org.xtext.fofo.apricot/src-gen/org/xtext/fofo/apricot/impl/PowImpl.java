 ...
 * <ul>
 *   <li>{@link org.xtext.fofo.apricot.impl.PowImpl#getBuiltInName <em>Built In Name</em>}</li>
 *   <li>{@link org.xtext.fofo.apricot.impl.PowImpl#getE1 <em>E1</em>}</li>
 *   <li>{@link org.xtext.fofo.apricot.impl.PowImpl#getE2 <em>E2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PowImpl extends Built_In_MethodsImpl implements Pow
{
  /**
  ...
  {
    return ApricotPackage.Literals.POW;
  }
  ...
  public void setBuiltInName(String newBuiltInName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApricotPackage.POW__BUILT_IN_NAME, oldBuiltInName, builtInName));
  }
  ...
  public NotificationChain basicSetE1(AdditiveExpression newE1, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ApricotPackage.POW__E1, oldE1, newE1);
  ...
  public void setE1(AdditiveExpression newE1)
  {
    if (newE1 != e1)
    {
      ...
      if (e1 != null)
        msgs = ((InternalEObject)e1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ApricotPackage.POW__E1, null, msgs);
      if (newE1 != null)
        msgs = ((InternalEObject)newE1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ApricotPackage.POW__E1, null, msgs);
      msgs = basicSetE1(newE1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApricotPackage.POW__E1, newE1, newE1));
  }
  ...
  public NotificationChain basicSetE2(AdditiveExpression newE2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ApricotPackage.POW__E2, oldE2, newE2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setE2(AdditiveExpression newE2)
  {
    if (newE2 != e2)
    {
      NotificationChain msgs = null;
      if (e2 != null)
        msgs = ((InternalEObject)e2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ApricotPackage.POW__E2, null, msgs);
      if (newE2 != null)
        msgs = ((InternalEObject)newE2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ApricotPackage.POW__E2, null, msgs);
      msgs = basicSetE2(newE2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApricotPackage.POW__E2, newE2, newE2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ApricotPackage.POW__E1:
        return basicSetE1(null, msgs);
      case ApricotPackage.POW__E2:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ApricotPackage.POW__BUILT_IN_NAME:
