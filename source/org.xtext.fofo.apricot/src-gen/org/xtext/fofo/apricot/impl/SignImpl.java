 ...
 * <ul>
 *   <li>{@link org.xtext.fofo.apricot.impl.SignImpl#getBuiltInName <em>Built In Name</em>}</li>
 *   <li>{@link org.xtext.fofo.apricot.impl.SignImpl#getEx <em>Ex</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SignImpl extends Built_In_MethodsImpl implements Sign
{
  /**
  ...
  {
    return ApricotPackage.Literals.SIGN;
  }
  ...
  public void setBuiltInName(String newBuiltInName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApricotPackage.SIGN__BUILT_IN_NAME, oldBuiltInName, builtInName));
  }
  ...
  public NotificationChain basicSetEx(AdditiveExpression newEx, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ApricotPackage.SIGN__EX, oldEx, newEx);
  ...
  public void setEx(AdditiveExpression newEx)
  {
    if (newEx != ex)
    {
      ...
      if (ex != null)
        msgs = ((InternalEObject)ex).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ApricotPackage.SIGN__EX, null, msgs);
      if (newEx != null)
        msgs = ((InternalEObject)newEx).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ApricotPackage.SIGN__EX, null, msgs);
      msgs = basicSetEx(newEx, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApricotPackage.SIGN__EX, newEx, newEx));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ApricotPackage.SIGN__BUILT_IN_NAME:
