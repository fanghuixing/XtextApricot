...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gcd</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.xtext.fofo.apricot.impl.GcdImpl#getBuiltInName <em>Built In Name</em>}</li>
 *   <li>{@link org.xtext.fofo.apricot.impl.GcdImpl#getE1 <em>E1</em>}</li>
 *   <li>{@link org.xtext.fofo.apricot.impl.GcdImpl#getE2 <em>E2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GcdImpl extends Built_In_MethodsImpl implements Gcd
{
  /**
  ...
  {
    return ApricotPackage.Literals.GCD;
  }
  ...
  public void setBuiltInName(String newBuiltInName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApricotPackage.GCD__BUILT_IN_NAME, oldBuiltInName, builtInName));
  }
  ...
  public NotificationChain basicSetE1(AdditiveExpression newE1, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ApricotPackage.GCD__E1, oldE1, newE1);
  ...
  public void setE1(AdditiveExpression newE1)
  {
    if (newE1 != e1)
    {
      ...
      if (e1 != null)
        msgs = ((InternalEObject)e1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ApricotPackage.GCD__E1, null, msgs);
      if (newE1 != null)
        msgs = ((InternalEObject)newE1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ApricotPackage.GCD__E1, null, msgs);
      msgs = basicSetE1(newE1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApricotPackage.GCD__E1, newE1, newE1));
  }
  ...
  public EList<AdditiveExpression> getE2()
  {
    if (e2 == null)
    {
      e2 = new EObjectContainmentEList<AdditiveExpression>(AdditiveExpression.class, this, ApricotPackage.GCD__E2);
    }
    return e2;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ApricotPackage.GCD__E1:
        return basicSetE1(null, msgs);
      case ApricotPackage.GCD__E2:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ApricotPackage.GCD__BUILT_IN_NAME:
