 ...
 * <ul>
 *   <li>{@link org.xtext.fofo.apricot.impl.AbsImpl#getBuiltInName <em>Built In Name</em>}</li>
 *   <li>{@link org.xtext.fofo.apricot.impl.AbsImpl#getEx <em>Ex</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AbsImpl extends Built_In_MethodsImpl implements Abs
{
  /**
  ...
  {
    return ApricotPackage.Literals.ABS;
  }
  ...
  public void setBuiltInName(String newBuiltInName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApricotPackage.ABS__BUILT_IN_NAME, oldBuiltInName, builtInName));
  }
  ...
  public NotificationChain basicSetEx(AdditiveExpression newEx, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ApricotPackage.ABS__EX, oldEx, newEx);
  ...
  public void setEx(AdditiveExpression newEx)
  {
    if (newEx != ex)
    {
      ...
      if (ex != null)
        msgs = ((InternalEObject)ex).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ApricotPackage.ABS__EX, null, msgs);
      if (newEx != null)
        msgs = ((InternalEObject)newEx).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ApricotPackage.ABS__EX, null, msgs);
      msgs = basicSetEx(newEx, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApricotPackage.ABS__EX, newEx, newEx));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ApricotPackage.ABS__BUILT_IN_NAME:
